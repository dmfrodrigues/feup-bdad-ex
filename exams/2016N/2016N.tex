...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item \textbf{Com a cláusula \texttt{UNIQUE} {\color{green}\checkmark}}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item Não quero responder
    \item \textbf{pode ser usada como qualquer tabela, exceto se só permitir inserção de registos se não juntar várias tabelas {\color{green}\checkmark}}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item Não quero responder
    \item \textbf{permitem a implementação em bases de dados relacionais de operações de natureza não declarativa (isto é, dificilmente implementáveis em SQL) {\color{green}\checkmark}}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    \item Não quero responder
    \item \textbf{definir um momento em que a base de dados está consistente {\color{green}\checkmark}}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item Não quero responder
    \item \textbf{é a vertical, que consiste na compra de hardware mais poderoso para armazenar todos os dados {\color{green}\checkmark}}
\end{enumerate}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item \textbf{a primeira minimiza a redundância enquanto que o segundo utiliza a redundância para otimizar a velocidade de consulta {\color{green}\checkmark}}
    \item Não quero responder
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item \textbf{2 sub-conjuntos, em que um serve para obter o modelo e outro para medir o seu desempenho preditivo {\color{green}\checkmark}}
    \item Não quero responder
\end{enumerate}
...
\begin{enumerate}[label=\alph*.]\itemsep0em
    ...
    \item \label{itm:2016N-11-d} \textbf{$A,F \rightarrow D$ {\color{green}\checkmark}}
