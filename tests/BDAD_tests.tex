...
\begin{secondpage}
    ...
    Built on \today~\currenttime~from \href{https://github.com/dmfrodrigues/feup-bdad-ex}{dmfrodrigues/feup-bdad-ex}, commit \input{COMMIT}\unskip.\par
